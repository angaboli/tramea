...
/**
 * Éditeur de chant personnalisé / medley : titre, chant de base (pour la
 * structure valide) et strophes (une par bloc séparé d'une ligne vide). À
 * l'export, le .pro de base est cloné et son texte remplacé.
 */
    ...
    <div className="fixed inset-0 z-50 flex items-end justify-center bg-black/40 p-0 sm:items-center sm:p-4" onClick={onClose}>
      ...
      <div className="flex max-h-[88vh] w-full max-w-lg flex-col overflow-hidden rounded-t-xl border border-border bg-surface shadow-xl sm:rounded-xl" onClick={(e) => e.stopPropagation()}>
        <div className="flex items-center justify-between border-b border-border p-4">
          <h2 className="text-base font-bold">Chant personnalisé / medley</h2>
        ...
        <div className="flex flex-col gap-3 overflow-y-auto p-4">
          <label className="flex flex-col gap-1.5">
            ...
            <input className={field} placeholder="Medley de Noël" value={titre} onChange={(e) => setTitre(e.target.value)} />
          </label>

          <div className="flex flex-col gap-1.5">
            <span className="text-sm font-semibold text-text-secondary">Chant de base (structure)</span>
